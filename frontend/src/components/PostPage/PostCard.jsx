...
}) =>
{
    ...
    return (
        <div
            className='bg-background rounded flex flex-col gap-2 shadow shadow-text/20 relative'
        >

            <div
                className='bg-text/30 absolute top-0 left-0 z-10 w-full h-full'
            >
            </div>
            ...
            >
                ...
                >
                    <h2
                        className='text-lg text-background font-medium'
                    >
